...
import edu.iis.powp.events.predefine.SelectRectangleTestListener;
...
public class TestPlotSoftPatterns
{
	...
	private static void setupPresetTests(Context context) {
	    ...
	    SelectRectangleTestListener SelectRectangleTestListener = new SelectRectangleTestListener();	   
	    
		context.addTest("Figure Joe 1", selectTestFigureOptionListener);	      
		context.addTest("Figure Joe 2", selectTestFigureOptionListener2);	
		context.addTest("Rectangle", SelectRectangleTestListener);	
	}
